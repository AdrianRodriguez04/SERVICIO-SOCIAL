...
void actualizarMetrics() {
  ...
  metricsLen = snprintf(
    ...
    "# TYPE dht22_temperature_celsius_n gauge\n"
    "dht22_temperature_celsius_n{sensor=\"dht22\",node=\"nodemcu_v3\"} %.2f\n"
    "# TYPE dht22_humidity_percent_n gauge\n"
    "dht22_humidity_percent_n{sensor=\"dht22\",node=\"nodemcu_v3\"} %.2f\n",
...
void loop() {
  ...
  // Página web
    ...
    int len = snprintf(
      ...
      "<title>NodeMCU V3 Monitor</title>"
      "</head><body style='font-family:Arial;text-align:center;'>"
      "<h2>NodeMCU V3: Monitoreo DHT22</h2>"
