...
void handleMetrics() {
  ...
  snprintf(buf, sizeof(buf),
    ...
    "dht22_temperatura{sensor_id=\"1\",microcontrolador=\"esp32_c3\"} %.2f\n"
    "# TYPE dht22_humedad gauge\n"
    "dht22_humedad{sensor_id=\"1\",microcontrolador=\"esp32_c3\"} %.2f\n",
...
void handleRoot() {
  ...
  snprintf(html, sizeof(html),
    ...
    "<title>ESP32-C3 - N.1</title>"
    "</head><body style='font-family:Arial;text-align:center;'>"
    "<h2>ESP32-C3 SuperMini - N.1: Monitoreo DHT22</h2>"
