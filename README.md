...
Este repositorio contiene el desarrollo técnico, código fuente y documentación del sistema de monitoreo ambiental que he realizado durante mi **Servicio Social** en el área de **Supercomputo de la DGTIC**. El objetivo principal es establecer una *red de sensores funcional* que permita la *supervisión constante* y el *alertamiento* temprano ante variaciones críticas de temperatura.
